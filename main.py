...
class jeu:
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load(os.path.join('C:/Users/MED/Downloads/Jeux_python-Snake--main', 'start_snake.png'))
        self.image_transform = pygame.transform.scale(self.image, (790, 580))

        self.image_end = pygame.image.load(os.path.join('C:/Users/MED/Downloads/Jeux_python-Snake--main', 'end_snake.png'))
